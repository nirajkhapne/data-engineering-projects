...
This project is designed to demonstrate transition from analytics to real-time data engineering by implementing scalable streaming concepts and distributed data processing patterns.

Suggested resume wording:

```text
Designed and implemented a real-time streaming analytics platform using Kafka, Spark Structured Streaming, MongoDB, and FastAPI with support for stateful processing, windowed aggregations, event-time watermarking, and stream joins.
```
